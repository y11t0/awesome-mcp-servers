...
-
[corebasehq/coremcp](https://github.com/corebasehq/coremcp) 🏎️ ☁️ 🏠 - MSSQL and Firebird (WIP) integration with secure reverse tunneling, schema inspection, and PII masking for legacy databases.
